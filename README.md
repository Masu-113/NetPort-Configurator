...
2. **Permisos elevados.**
    ...
    - Revisar el manual de usuario que brinda NetPort: [Manual de Usuario](https://github.com/Masu-113/NetPort/blob/feature/documentacion/ManualDeUsuario-NetPort_v1.0.pdf).
